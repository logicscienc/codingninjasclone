      ...
      <div className="max-w-[1000px] mx-auto px-4 py-12 flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-6 mt-6 md:mt-12">
          ...
          <p className="text-gray-300 text-sm md:text-base">
            Upskill to Lead AI-Driven Innovation with Generative AI &
            Agent-Based Systems
          </p>
          <div className="flex flex-wrap gap-3 text-xs font-medium">
            <span className="bg-[#1c1f2b] px-3 py-1 rounded-full flex items-center gap-1">
              <img src={futureready} className="h-6 w-6" /> Hands-on projects
            </span>

            <span className="bg-[#1c1f2b] px-3 py-1 rounded-full flex items-center gap-1">
              <img src={placement} className="h-6 w-6" /> Expert-Led Live
              Classes
            </span>
            <span className="bg-[#1c1f2b] px-3 py-1 rounded-full flex items-center gap-1">
              <img src={stanford} className="h-6 w-6" /> Faculty from leading AI
              startups
            </span>
          </div>
