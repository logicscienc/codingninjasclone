...
const SECTIONS = [
  ...
  { id: "ac", label: "E&ICT Academy, IITG" },
...
const Carriculum = ({
  ...
  return (
    <div>
      ...
      <div ref={navRef} className="sticky top-[80px] z-50 bg-white">
        <div className="max-w-[900px] mx-auto bg-white px-6 py-3 rounded-full shadow-md border border-gray-200">
