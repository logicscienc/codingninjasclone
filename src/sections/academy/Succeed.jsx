    ...
    <div className="flex flex-col items-center px-4 py-10 space-y-20">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-700 text-[15px]">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                co-designed with IITM Pravartak IIT faculties
              </span>
            </li>
            <li className="flex items-start gap-3">
              <FaGraduationCap className="text-blue-600 mt-1" />
              <span>
                Get access to IITM Pravartak IIT faculty{" "}
                <span className="text-red-400 font-medium">Guest Lectures</span>
              </span>
            </li>
            <li className="flex items-start gap-3">
          ...
          <a
            ...
            rel="noopener noreferrer"
             className="mt-6 inline-block bg-blue-700 text-white font-medium px-6 py-2 rounded hover:bg-blue-800 transition"
          >
            Enrol Now
          </a>
        </div>
      ...
      <div className="max-w-[1000px] w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-gray-700 mb-6">
            Unlock the path to success with the mindset and perseverance of a
            top achiever.
          </p>
          ...
          <ul className="space-y-4 text-gray-700 text-[15px]">
            ...
            <li className="flex items-start gap-3">
              <FaGraduationCap className="text-blue-600 mt-1" />
              <span>
                Grow your network by connecting with{" "}
                <span className="text-red-400 font-medium">
                  10,000+ peers and 10X mentors
                </span>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PiPaintBrushBroadThin className="text-blue-600 mt-1" />
              <span>
                Get access to and be a part of{" "}
                <span className="text-red-400 font-medium">
                  Open Source Clubs
                </span>{" "}
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                post program completion by Coding Ninjas
              </span>
            </li>
          </ul>
          <button
