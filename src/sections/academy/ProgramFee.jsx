      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-6">
        ...
        <div className="flex flex-col gap-4 w-full md:w-1/3">
          <div className="border-2 border-blue-600 bg-blue-600 text-white text-center rounded-md py-6 px-4">
            <p className="text-base sm:text-lg">Total Program Fee</p>
            <p className="text-xl sm:text-2xl font-bold mt-1">₹79,999</p>
          </div>

          <div className="border-2 border-blue-600 text-blue-600 text-center rounded-md py-6 px-4">
            <p className="text-base sm:text-lg">Book your seat now</p>
            <p className="text-xl sm:text-2xl font-bold mt-1">₹2,500</p>
          </div>
        </div>
        ...
        <div className="flex-1">
          ...
          <p className="text-2xl sm:text-3xl font-bold mb-2">
            ₹ 6,458<span className="text-base sm:text-xl">/month</span>
          </p>
          ...
          <a
            ...
            className="inline-block bg-blue-600 text-white text-sm sm:text-base px-6 py-2 rounded-md hover:bg-blue-700 transition-all mt-6"
          >
            Enrol Now
          </a>
        </div>
