...
import iitg_student_da from "./img/iitg_student_da.png";
...
const faqData = [
  {
    ...
    answer:
      "With specialized skills, you’ll become a certified industry-ready Data Structures & Algorithm in just 6 months. Plus, you’ll get Student Training cum Internship Certificate from E&ICT Academy, IIT GuwahatiOrientation and graduation ceremony at IIT Guwahati campus. E&ICT Academy, IIT Guwahati Alumni status Gen AI-infused curriculum Curriculum co-designed with IIT facultyOccasional Guest lectures by IIT faculty",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "Classes will be conducted online. Weekly three live classes, 2 hours each, MWF 8-10 PM. Recordings for each will be provided after class.The program offers regular assignments and tests and unlimited 1:1 doubt support, ensuring a personalized and effective learning experience.",
  },
  {
        ...
        <div className="bg-white mt-6 rounded-xl p-4 sm:p-6 shadow-md flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            <div className="flex items-start gap-4 mb-6">
              <img src={iitg_student_da} alt="Course Logo" className="h-10 w-10" />
              <div>
